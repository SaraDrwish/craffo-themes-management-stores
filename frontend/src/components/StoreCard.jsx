  ...
  return (
    <div className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-xl transition-all duration-300 border border-light-mauve hover:border-purple group relative">
      <div className="relative h-40 bg-gray-100 overflow-hidden">
        <img
          src="https://placehold.co/600x400?text=Store+Preview"
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="flex gap-2">
            <a
              ...
              className="bg-purple text-white px-3 py-1 rounded-full text-sm hover:bg-dark-navy transition"
            >
              زيارة المتجر
            </a>
            <button
              onClick={copyUrl}
              className="border border-gray-300 text-gray-600 px-3 py-1 rounded-full text-sm hover:bg-gray-100 transition"
            >
              📋 نسخ
            </button>
          </div>
